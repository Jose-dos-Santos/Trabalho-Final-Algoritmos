...
def iniciar():
    lendo_arquivo = ler_arquivo_entrada.arquivo_vazio('entrada_dados.txt')


    if lendo_arquivo == False:
        ...
        arquivo = ler_arquivo_entrada.criar_aquivo_de_saida()
        arquivo = (arquivo)  # Abrindo meu Arquivo Saída.txt
        arquivo.write(' O arquivo de entrada está vazio ')  # Gravado uma frase no arquivo
        arquivo.write("\n")
        arquivo.write(" Insira os dados corretos para que seja gerado a saída esperada ")
        arquivo.close()
