...
def ler_arquivo1():
    heap = []
    with open('entrada.txt',
              encoding='utf-8') as fp:  # Abrindo o Arquivo de entrada, o metodo with se encarrega de abrir e fechar o arquivo
...
def ler_arquivo2():
    ...
    for j in range(m):
        with open('entrada.txt') as fp:  # Abrindo o Arquivo de entrada
            for i, line in enumerate(fp):
...
# Algumas entrada para realizar testes, caso queira testar copiar para o arquivo entrada.txt
